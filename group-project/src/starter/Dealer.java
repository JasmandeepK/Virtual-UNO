...
//		System.out.println(start);
		...
		//
		deck[50] = new UnoCard(3,0);
		deck[51] = new UnoCard(3,1);
		deck[52] = new UnoCard(3,1);
		deck[53] = new UnoCard(3,2);
		deck[54] = new UnoCard(3,2);
		deck[55] = new UnoCard(3,3);
		deck[56] = new UnoCard(3,3);
		deck[57] = new UnoCard(3,4);
		deck[58] = new UnoCard(3,4);
		deck[59] = new UnoCard(3,5);
		deck[60] = new UnoCard(3,5);
		deck[61] = new UnoCard(3,6);
		deck[62] = new UnoCard(3,6);
		deck[63] = new UnoCard(3,7);
		deck[64] = new UnoCard(3,7);
		deck[65] = new UnoCard(3,8);
		deck[66] = new UnoCard(3,8);
		deck[67] = new UnoCard(3,9);
		deck[68] = new UnoCard(3,9);
		deck[69] = new UnoCard(3,10);
		deck[70] = new UnoCard(3,10);
		deck[71] = new UnoCard(3,11);
		deck[72] = new UnoCard(3,11);
		deck[73] = new UnoCard(3,12);
		deck[74] = new UnoCard(3,12);
		
		//
		deck[75] = new UnoCard(2,0);
		deck[76] = new UnoCard(2,1);
		deck[77] = new UnoCard(2,1);
		deck[78] = new UnoCard(2,2);
		deck[79] = new UnoCard(2,2);
		deck[80] = new UnoCard(2,3);
		deck[81] = new UnoCard(2,3);
		deck[82] = new UnoCard(2,4);
		deck[83] = new UnoCard(2,4);
		deck[84] = new UnoCard(2,5);
		deck[85] = new UnoCard(2,5);
		deck[86] = new UnoCard(2,6);
		deck[87] = new UnoCard(2,6);
		deck[88] = new UnoCard(2,7);
		deck[89] = new UnoCard(2,7);
		deck[90] = new UnoCard(2,8);
		deck[91] = new UnoCard(2,8);
		deck[95] = new UnoCard(2,9);
		deck[93] = new UnoCard(2,9);
		deck[94] = new UnoCard(2,10);
		deck[95] = new UnoCard(2,10);
		deck[96] = new UnoCard(2,11);
		deck[97] = new UnoCard(2,11);
		deck[98] = new UnoCard(2,12);
		deck[99] = new UnoCard(2,12);
	...
	public static void main(String[] args) {
		...
		UnoCard c;
		for(int i = 0; i < 108; i++) {
			 c = dealerDeck.getDeck()[i];
			 System.out.println(dealerDeck.getDeck()[i]);
	...
	public void shuffle() {
        ...
        for (int i = 0; i < deck.length; i++) {
             ...
             UnoCard temp = deck[i]; // Card from random position
             deck[i] = deck[rand];
             deck[rand] = temp;
        }
        next = 1;
	 ...
	 public UnoCard deal() { // Deals one card at a time
		 if (next > 108) { // If deck is depleted
             shuffle();
		 }
